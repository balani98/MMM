...
@Component({
  selector: 'app-channel-quantile-stats',
  templateUrl: './channel-quantile-stats.component.html',
  styleUrls: ['./channel-quantile-stats.component.scss']
})
export class ChannelQuantileStatsComponent {
